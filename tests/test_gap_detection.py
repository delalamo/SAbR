...
class TestDetectBackboneGaps:
    ...
    def test_uses_correct_atom_indices(self):
        ...
        # All other atom pairs are close together
        ...
        # but close to residue 0's CA and CB atoms
        ...
        # If incorrectly using CA: CA[0] to N[1] = |5 - 1| = 4 Å
        # If incorrectly using CB: CB[0] to N[1] = |5 - 3| = 2 Å
